---
title: Technology and Coding tutorials with LearnPack
tags:
  - learnpack
  - javascript
  - git
description: >-
  Discover LearnPack for interactive technology and coding tutorials! Master the most demanded skills in the market with
  auto-graded exercises and instant feedback. Start learning today!
---
<!--hide-->
# Technology and Coding tutorials with LearnPack
<!--endhide-->

At 4Geeks.com, you will see the word "LearnPack" here and there. You will use LearnPack A LOT to practice technology tutorials and small exercises. This article explains what it is and how to use it so you can run all the tutorials smoothly.

## What is LearnPack?

LearnPack is a tool designed by 4Geeks to teach and learn technology and coding-related skills with interactive, as well as auto-graded and AI-enabled tutorials and exercises. It acts as a package manager for educational content, similar to platforms like npm, brew, etc. but exclusively for technical educational packages.
...
- Click the button that says **"Start interactive exercise"** (or **"Continue this exercise"** if you started before)
...
- Click the button that says **"Create codespace"** (or open the codespace you already have created)
